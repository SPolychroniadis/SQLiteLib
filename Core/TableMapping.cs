...
namespace SQLiteLib.Core
{
    public class TableMapping
    {
        ...
        PreparedSQLiteInsertCommand _insertCommand;
        ...
        PreparedSQLiteInsertCommand CreateInsertCommand(SQLiteConnection conn, string extra)
        {
